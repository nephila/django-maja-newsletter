...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SendBatch.user'
        db.add_column('newsletter_sendbatch', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)
        db.rename_column('newsletter_sendbatch', 'sendings', 'emails')


    def backwards(self, orm):
        # Deleting field 'SendBatch.user'
        db.delete_column('newsletter_sendbatch', 'user_id')
        db.rename_column('newsletter_sendbatch', 'emails', 'sendings')
    ...
    models = {
        ...
        u'maja_newsletter.sendbatch': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'emails': ('django.db.models.fields.IntegerField', [], {}),
